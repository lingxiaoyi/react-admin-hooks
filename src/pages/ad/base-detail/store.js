...
class FlowAdStore {
  ...
  @action
  changeForm = (payload = {}) => {
    Object.keys(payload).map(l => {
			this.formData[l] = payload[l];
		})
  }
}

export default new FlowAdStore();